...
for i in range(0, total_stock_count):
    cursor.execute(
        'insert into allstock_2019_0726_1 (code,name,industry,area,pe,outstanding,totals,totalAssets,liquidAssets, fixedAssets,reserved,reservedPerShare, eps, bvps, pb, timeToMarket,undp, perundp, rev, profit, gpr, npr, holders) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',
